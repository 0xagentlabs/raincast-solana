...
Solana Devnet 天气预测市场 Demo。用户可从 24 个国内外知名城市中选择地点，预测未来 12 小时内是否达到 0.1 mm 降水；Open‑Meteo 数据由受控预言机签名并用于链上结算。城市选择器按“国内 / 海外”分组，覆盖上海、北京、香港、东京、新加坡、伦敦、纽约、悉尼等城市。每个市场开放预测 11 小时 55 分钟、在第 12 小时结算；页面和链上按城市派生的 schedule PDA 会阻止同一城市创建时间重叠的市场，不同城市可同时开市。
